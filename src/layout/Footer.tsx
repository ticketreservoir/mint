import logo from "../assets/icon/mint.webp";
import mintclub from "../assets/icon/mintclub.webp";
const Footer = () => {
  return (
    <footer className="relative z-10 grid w-full grid-cols-1 border-t border-textGrey py-10 px-5 md:px-[calc((100%-960px)/2)] sm:py-20 md:grid-cols-2">
      <div className="flex justify-between sm:flex-col">
        <div className="flex w-full items-start justify-between sm:flex-col sm:justify-center">
          <div className="flex flex-col items-start gap-2.5 sm:flex-row sm:items-center sm:justify-start">
            <div className="flex items-center gap-2.5">
              ...
              />
              <div className="flex w-full justify-between sm:w-auto sm:flex-col">
                <img
                  alt="mint text"
                  loading="lazy"
                  width="121"
            ...
            <div className="ml-[50px] flex items-center justify-start gap-3 sm:ml-0">
              <a href="#">
                <div tabIndex={0}>
                  <svg
                    fill="none"
          ...
          <a
            className="flex w-fit origin-top-right scale-[0.85] items-center justify-center rounded-xl bg-[#20222A] p-2 px-4 hover:scale-[0.86] sm:mt-5 sm:p-3 sm:px-7"
            href="#"
            style={{
              boxShadow: "rgb(46, 60, 81) 0px 0px 12px -1px",
              border: " 2px ridge rgb(46, 60, 81)",
            }}
          >
            <div className="relative">
              <div className="absolute right-5 top-2 aspect-square h-[5px] w-[5px] animate-ping rounded-full bg-[#40b884]"></div>
              <div className="absolute right-5 top-2 aspect-square h-[5px] w-[5px] rounded-full bg-[#40b884]"></div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="159"
                height="44"
              ...
              >
                <g xmlns="http://www.w3.org/2000/svg">
                  <path
                    opacity="0.8"
                    d="M37.0296 7.39796L37.2562 8.72497C37.2562 8.8008 37.4828 10.2416 37.4828 12.4785C37.4828 14.6017 37.294 17.5212 36.5009 20.706C35.7456 23.7392 34.386 27.379 31.9311 30.943C29.4763 34.507 25.8884 37.9951 20.7143 40.8008L20.0723 41.142L19.4303 40.8008C14.2184 37.9951 10.6683 34.469 8.21348 30.943C5.75863 27.379 4.39902 23.7771 3.64368 20.706C2.85058 17.5212 2.66174 14.6017 2.66174 12.4785C2.66174 10.2416 2.88835 8.8008 2.88835 8.72497L3.11495 7.39796C3.19048 6.94298 2.88835 6.52592 2.43514 6.45009C1.98194 6.37426 1.5665 6.67758 1.49097 7.13255L1.26437 8.45957C1.2266 8.61123 1 10.1278 1 12.4785C1 14.7155 1.2266 17.7487 2.05747 21.1231C2.77505 24.3458 4.21019 28.1752 6.81611 31.9288C9.42202 35.6823 13.1987 39.398 18.6372 42.3174L19.6569 42.8861C19.9212 43.0378 20.1856 43.0378 20.45 42.8861L21.4697 42.3174C26.9081 39.398 30.6848 35.6823 33.2907 31.9288C35.8966 28.1752 37.3318 24.3458 38.1249 21.161C38.9558 17.7866 39.1824 14.7913 39.1824 12.5164C39.1824 10.1657 38.9558 8.64914 38.918 8.49748L38.6914 7.17047C38.6159 6.71549 38.2004 6.41217 37.7472 6.488C37.2562 6.52592 36.9541 6.94298 37.0296 7.39796Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.529384"
                    stroke-miterlimit="10"
                  ></path>
                  <path
                    opacity="0.8"
                    d="M7.64702 6.48815L20.0723 2.69668L32.762 6.6019C33.2152 6.75356 33.6684 6.48815 33.8195 6.03318C33.9706 5.5782 33.7062 5.12322 33.253 4.97156L20.2989 1.02844C20.1479 0.99052 19.959 0.99052 19.808 1.02844L7.15605 4.89574C6.70284 5.04739 6.47624 5.50237 6.58954 5.95735C6.74061 6.37441 7.19381 6.63981 7.64702 6.48815Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.529384"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M1.52875 7.66442L19.317 42.508C19.468 42.7734 19.7324 42.963 20.0345 42.963C20.3367 42.963 20.6388 42.8113 20.7899 42.508L31.629 22.1478V22.1099L38.6159 7.62651C38.8047 7.20945 38.6536 6.71656 38.2382 6.52698C37.8228 6.33741 37.3318 6.48907 37.143 6.90613L30.1561 21.3895L20.0723 40.3469L3.00166 6.90613C2.77506 6.48907 2.28409 6.33741 1.86865 6.52698C1.49098 6.75447 1.30215 7.24736 1.52875 7.66442Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.529384"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M10.0263 23.1702H29.8162C30.2694 23.1702 30.647 22.7911 30.647 22.3361C30.647 21.8811 30.2694 21.502 29.8162 21.502H10.0263C9.5731 21.502 9.19543 21.8811 9.19543 22.3361C9.19543 22.7911 9.5731 23.1702 10.0263 23.1702Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.529384"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M85.0412 23.0385V24.498H74.6748V28.8131H83.0185V30.3044H74.6748V34.6195H85.0412V36.079H73.2209V23.0703H85.0412V23.0385Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.265807"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M106.406 25.1961V29.0035C106.406 29.6064 106.185 30.114 105.774 30.5265C105.363 30.939 104.858 31.1611 104.257 31.1611H102.266L106.343 36.0156H104.415L100.338 31.1928H95.5973C95.5025 31.1928 95.2496 31.1611 94.902 31.1293V36.0473H93.4482V23.0385H104.257C104.858 23.0385 105.363 23.2606 105.774 23.6731C106.185 24.0856 106.406 24.5932 106.406 25.1961ZM95.5973 29.7015H104.225C104.415 29.7015 104.573 29.6381 104.7 29.5112C104.826 29.3843 104.889 29.2256 104.889 29.0352V25.2278C104.889 25.0374 104.826 24.8788 104.7 24.7201C104.573 24.5932 104.415 24.498 104.225 24.498H95.5973C95.4077 24.498 95.2496 24.5615 95.0916 24.7201C94.9652 24.8471 94.8704 25.0374 94.8704 25.2278V29.0352C94.8704 29.2256 94.9336 29.3843 95.0916 29.5112C95.218 29.6381 95.4077 29.7015 95.5973 29.7015Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.265807"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M114.15 23.0385H127.108V24.498H121.355V36.0473H119.902V24.498H114.15V23.0385Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.265807"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M134.946 36.0473V23.0385H136.399V36.0473H134.946Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.265807"
                    stroke-miterlimit="10"
                  ...
                  <path
                    opacity="0.8"
                    d="M155.868 23.0385H157.733L152.328 29.5429L157.764 36.0473H155.868L151.032 30.2727H146.861V36.0473H145.375V23.0385H146.861V28.8131H151.032L155.868 23.0385Z"
                    fill="#fff"
                    stroke="#fff"
                    stroke-width="0.265807"
                    stroke-miterlimit="10"
        ...
        <div className="space-y-3">
          <div className="hidden text-sm text-grey md:block">
            © 2024 BourbonShake Inc. All rights reserved
          </div>
        </div>
      </div>
      <div>
        <div className="mt-10 text-base font-bold sm:text-lg md:mt-0">
          Subscribe to stay updated in the club
        </div>
        <div className="mt-5 flex w-full items-center py-2.5 text-lg">
          <div
            id="custom-substack-embed"
            className="w-full md:max-w-full border-green-300 border "
          >
        ...
        <div className="mt-10 flex justify-between text-sm text-grey sm:text-base sm:leading-[1.5]">
          <div>
            <div className="font-bold text-white">Use</div>
            <a className="mt-2.5 block" href="#">
              Create token/NFT
            </a>
            <a className="mt-1 block" href="#">
              Explore
            </a>
            <a className="mt-1 block" href="#">
              Airdrops
          ...
          <div>
            ...
            <a className="mt-2.5 block" href="mailto:admin@hunt.town">
              Email
            </a>
            <a className="mt-1 block" href="#">
              Terms of Service
            ...
            <a
              ...
              href="https://docs.mint.club/mintpt/mintdao"
            >
              Mint Dao
            </a>
            <a
              className="mt-1 block"
              href="https://docs.mint.club/mintpt/grant"
            >
              Mint Grant
            </a>
            <a
              className="mt-1 block"
              href="https://forms.gle/rgGudP1efntYRbVA8"
            >
              Report Abuse
            </a>
          </div>
      ...
      <div className="mt-10 block text-sm text-grey md:hidden">
        © 2024 BourbonShake Inc. All rights reserved
      </div>
      <span className="absolute bottom-4 right-4 z-[99999999] text-xs text-grey">
        v0.1.923
      </span>
    </footer>
  );
